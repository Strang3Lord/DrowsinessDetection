...
import com.pi.drowsinessdetection.CameraElement.CameraPreview;
import com.pi.drowsinessdetection.CameraElement.Overlay;
...
public class DetectionActivity extends AppCompatActivity {
    ...
    private String key_2 = "drivers project";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        end_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent next = new Intent(DetectionActivity.this,MainActivity.class);
                count=0;
                count1=0;
        ...
        int cc = ActivityCompat.checkSelfPermission(this, Manifest.permission.CAMERA);
        if (cc == PackageManager.PERMISSION_GRANTED) {
            createCameraSource();
        } else {
    ...
    private void requestCameraPermission() {
        ...
        Snackbar.make(mOverlay,"permission_camera",
    ...
    {   play_media();
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                play_media();
                AlertDialog dig;
                dig = new AlertDialog.Builder(DetectionActivity.this)
                        .setTitle("Alert !!!")
                        .setMessage("You are experiencing Drowsiness, Click OK to Stop the Alarm")
